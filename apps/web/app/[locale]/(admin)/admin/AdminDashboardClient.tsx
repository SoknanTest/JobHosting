  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600 font-medium">Overview of the platform activity and moderation</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {recentUsers.map((user) => (
              <div key={user.id} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-gray-50 flex items-center justify-center font-bold text-gray-400 border border-gray-100">
                ...
                <span className={`px-2.5 py-0.5 rounded-lg bg-gray-50 text-[10px] font-black uppercase tracking-tighter border border-gray-100 ${
        ...
        <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl shadow-indigo-50/20">
          ...
          <div className="space-y-6">
              ...
              <div key={job.id} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">{job.company?.name || 'Private'}</p>
                  </div>
                </div>
            ...
            {recentJobs.length === 0 && (
              <div className="py-10 text-center text-gray-400 text-sm font-medium">No jobs found.</div>
            )}
          </div>
        </div>
      </div>
