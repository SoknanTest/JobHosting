    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 h-[calc(100vh-140px)]">
      <div className="bg-white rounded-3xl border border-gray-400 shadow-xl overflow-hidden flex h-full">
        ...
        {selectedConversation ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center bg-gray-300/30 text-gray-900">
            <div className="h-16 w-16 rounded-3xl bg-gray-300 flex items-center justify-center mb-4">
